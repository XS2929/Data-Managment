...
CREATE SEQUENCE course_unique_number_seq START WITH 100 NOCACHE ORDER;
...
CREATE SEQUENCE instructor_instructor_id_seq START WITH 100 NOCACHE ORDER;
...
CREATE SEQUENCE p2_session_session_id_seq START WITH 100 NOCACHE ORDER;
